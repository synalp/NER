...
public final class LogMath implements Serializable {
    ...
    public final static boolean PROP_USE_ADD_TABLE_DEFAULT = false;
    ...
    private float logBase = PROP_LOG_BASE_DEFAULT;

    private boolean useAddTable = PROP_USE_ADD_TABLE_DEFAULT;
